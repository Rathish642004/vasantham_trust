...
import { GraduationCap, Calendar, MapPin, ArrowLeft } from "lucide-react"
import Link from "next/link"
import Image from "next/image"
import { format } from "date-fns"

export const metadata = {
  title: "Educational Support - Vasantham Charitable Trust",
  description: "View all our educational support events and activities in rural Tamil Nadu.",
}
        ...
        <section className="border-b bg-gradient-to-br from-primary/5 to-accent/5 py-12 md:py-16">
          <div className="container px-4">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mb-4 font-serif text-4xl font-bold md:text-5xl text-balance">Educational Support</h1>
              <p className="text-lg text-muted-foreground leading-relaxed text-balance">
                School supplies, scholarships, and tutoring programs for underprivileged children in rural areas.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border-b bg-background py-6">
          <div className="container px-4">
            <form method="get" className="mx-auto flex max-w-4xl flex-wrap gap-3">
              <Select name="year" defaultValue={params.year || "0"}>
              ...
              <Select name="month" defaultValue={params.month || "0"}>
                <SelectTrigger className="w-[140px]">
              ...
              <Button asChild variant="outline" size="sm">
                <Link href="/activities/education">Clear Filters</Link>
              </Button>
            </form>
          </div>
        </section>
