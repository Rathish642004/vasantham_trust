...
import { Stethoscope, Calendar, MapPin, ArrowLeft } from "lucide-react"
import Link from "next/link"
import Image from "next/image"
import { format } from "date-fns"

export const metadata = {
  title: "Medical Camps - Vasantham Charitable Trust",
  description: "View all our medical camp events and activities in rural Tamil Nadu.",
}

export default async function MedicalCampsPage({
  searchParams,
}: {
        ...
        <section className="border-b bg-gradient-to-br from-accent/5 to-primary/5 py-12 md:py-16">
          <div className="container px-4">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mb-4 font-serif text-4xl font-bold md:text-5xl text-balance">Medical Camps</h1>
              <p className="text-lg text-muted-foreground leading-relaxed text-balance">
                Free health checkups, medicines, and healthcare awareness programs in remote villages.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border-b bg-background py-6">
          <div className="container px-4">
            <form method="get" className="mx-auto flex max-w-4xl flex-wrap gap-3">
              <Select name="year" defaultValue={params.year || currentYear.toString()}>
              ...
              <Select name="month" defaultValue={params.month || "1"}>
                <SelectTrigger className="w-[140px]">
              ...
              <Button asChild variant="outline" size="sm">
                <Link href="/activities/medical-camps">Clear Filters</Link>
              </Button>
            </form>
          </div>
        </section>
