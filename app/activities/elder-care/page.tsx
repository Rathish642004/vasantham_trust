...
export const metadata = {
  title: "Elder Care Services - Vasantham Charitable Trust",
  description: "View all our elder care events and activities in rural Tamil Nadu.",
}
        ...
        <section className="border-b bg-gradient-to-br from-primary/5 to-accent/5 py-12 md:py-16">
          <div className="container px-4">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mb-4 font-serif text-4xl font-bold md:text-5xl text-balance">Elder Care Services</h1>
              <p className="text-lg text-muted-foreground leading-relaxed text-balance">
                Regular visits, medical assistance, and companionship programs for elderly citizens in rural Tamil Nadu.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container px-4">
            <form method="get" className="mx-auto flex max-w-4xl flex-wrap gap-3">
              ...
              <Button asChild variant="outline" size="sm">
                <Link href="/activities/elder-care">Clear Filters</Link>
              </Button>
            </form>
          </div>
        </section>
